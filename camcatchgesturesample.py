...
while True:
    ...
    cv2.rectangle(c,(p1x,p1y),(p1x+100+k*20,p1y+100+k*20),0)
    cv2.imshow('len',c)
    print p1y,p2y,p1x,p2x
    key=cv2.waitKey(1)
    if key==27:
        break
output=cv2.resize(d[p1y:p1y+100+k*20,p1x:p1x+100+k*20],(20,20))
cv2.imwrite('C:\\deeplearning\\gesturesample\\gg1%f.jpg'%random.random(),output)
capture.release()
