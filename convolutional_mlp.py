...
def load_data(dataset):
    ...
    f.close()
    f2.close()'''
    pos_indexfile='C:\\Users\\Acer\\Documents\\Visual Studio 2010\\Projects\\face\\mit\\faces\\info.txt'
    neg_indexfile='C:\\Users\\Acer\\Documents\\Visual Studio 2010\\Projects\\face\\mit\\nonfaces\\bg.txt'    
    pos_rawbuffer=getbuffer(pos_indexfile,'face_pos.pickle',2900,1)
    neg_rawbuffer=getbuffer(neg_indexfile,'face_neg.pickle',93500,0) 
    print '...file loaded'
    train_set=[[],[],[]]
    for i in range(len(pos_rawbuffer[0])):
        train_set[0].append(pos_rawbuffer[0][i])
        train_set[1].append(pos_rawbuffer[1][i])
        train_set[2].append(0)
    for i in range(len(neg_rawbuffer[0])):
        train_set[0].append(neg_rawbuffer[0][i])
        train_set[1].append(neg_rawbuffer[1][i])
        train_set[2].append(0)
...
def evaluate_lenet5(learning_rate=0.001, n_epochs=200,
    ...
    with open('W_layer0.pickle', 'rb') as f:
        layer0.W.set_value(pickle.load(f))
    with open('B_layer0.pickle', 'rb') as f:
        layer0.b.set_value(pickle.load(f))
    with open('W_layer1.pickle', 'rb') as f:
        layer1.W.set_value(pickle.load(f))
    with open('B_layer1.pickle', 'rb') as f:
        layer1.b.set_value(pickle.load(f))
    with open('W_layer2.pickle', 'rb') as f:
        layer2.W.set_value(pickle.load(f))
    with open('B_layer2.pickle', 'rb') as f:
        layer2.b.set_value(pickle.load(f))
    with open('W_layer3.pickle', 'rb') as f:
        layer3.W.set_value(pickle.load(f))
    with open('B_layer3.pickle', 'rb') as f:
    ...
    with open('W_layer0.pickle', 'wb') as f:
        pickle.dump(layer0.W.get_value(),f)
    with open('B_layer0.pickle', 'wb') as f:
        pickle.dump(layer0.b.get_value(),f)
        
    with open('W_layer1.pickle', 'wb') as f:
        pickle.dump(layer1.W.get_value(),f)
    with open('B_layer1.pickle', 'wb') as f:
        pickle.dump(layer1.b.get_value(),f)

    with open('W_layer2.pickle', 'wb') as f:
        pickle.dump(layer2.W.get_value(),f)
    with open('B_layer2.pickle', 'wb') as f:
        pickle.dump(layer2.b.get_value(),f) 
        
    with open('W_layer3.pickle', 'wb') as f:
        pickle.dump(layer3.W.get_value(),f)
    with open('B_layer3.pickle', 'wb') as f:
